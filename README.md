...
<p align="center">
  <a href="https://devtools.at/tools/json-escape"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Escape/unescape JSON strings</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/json-escape">Try Online</a> •
...
**[Try JSON Escape online at DevTools.at →](https://devtools.at/tools/json-escape)**
...
Escape/unescape JSON strings. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/json-escape';
